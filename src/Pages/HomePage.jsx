		...
		<>
			<section id="homepage">
				...
				<article id="intro-cont">
					...
					/> */}
					<p>
						At Brewverse our love for craft beer is boundless, and our mission
						is to shine a spotlight on the hidden gems of the brewing world.
						With frothy fervor and unbridled enthusiasm, we dive deep into the
						realms of rare and lesser-known brews, unearthing unique flavors and
						telling the untold tales behind each artfully crafted pint.
					</p>
				</article>
			</section>
		</>
